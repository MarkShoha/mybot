...
def sfilm(m, res=False):
    first12 = ['бегущий в лабиринте\nПодростки пытаются выбраться из изолированного «приюта». Начало молодежной саги по бестселлеру Джеймса Дэшнера.', 'люси\nНаивная студентка превращается в сверхчеловека. Экшен со Скарлетт Йоханссон о возможностях человеческого мозга.', 'человек паук нет пути домой\nЖизнь и репутация Питера Паркера оказываются под угрозой, поскольку Мистерио раскрыл всему миру тайну личности Человека-паука. Пытаясь исправить ситуацию, Питер обращается за помощью к Стивену Стрэнджу, но вскоре всё становится намного опаснее.', 'конек горбунок\nПростой парень Иван и волшебный конь служат царю-самодуру. Фильм-сказка с уникальной компьютерной графикой.']
